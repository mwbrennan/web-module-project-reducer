...
import { applyNumber, changeOperation, clearDisplay, updateMemory, addMemory, clearMemory } from './actions/index'
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton onClick={() => handleAddMem()} value={"M+"}/>
              <CalcButton onClick={() => handleUpdateMem()} value={"MR"}/>
